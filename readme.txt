...
Too many files in this to annotate each file. This folder is for the Polymer web components library. The contents are found in this repository. https://github.com/polymer. To update to the latest library files, you need to use polymer-cli. Download from https://github.com/Polymer/polymer-cli
